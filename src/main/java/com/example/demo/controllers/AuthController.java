...
import com.example.demo.model.dao.JwtDTO;
import com.example.demo.model.dao.LoginUsuario;
import com.example.demo.model.dao.Mensaje;
import com.example.demo.model.dao.NuevoUsuario;
import com.example.demo.models.entity.Rol;
import com.example.demo.models.entity.Usuario;
import com.example.demo.models.services.RolService;
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        Usuario usuario =
                new Usuario(nuevoUsuario.getNombre(), nuevoUsuario.getNombreUsuario(), nuevoUsuario.getEmail(),
                        passwordEncoder.encode(nuevoUsuario.getPassword()), nuevoUsuario.getApellido(),nuevoUsuario.getRut());
